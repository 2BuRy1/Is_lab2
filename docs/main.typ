...
GitHub: https://github.com/2BuRy1/Is_lab2/tree/main

= Вывод
В ходе выполнения лабороторной работы разобрался в уровне изоляций транзакций, научился писать нагрузочные тесты при помощи Apache Jmeter.
Реализовал дополнительные ограничения на уровне бизнес-логики.
