...
export const unwrap = (axiosResponse) => {
    ...
    if (d && typeof d === 'object' && ('data' in d || 'status' in d || 'message' in d || 'title' in d)) {
...
export const ticketsApi = {
    ...
    update: (id, payload) =>
        callFirst(_tickets, ['updateTicket', 'updateTicketId', 'update_ticket', 'updateTicket1'], id, payload).then(unwrap),
